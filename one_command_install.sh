...
echo -e "${BLUE}Creating server management script...${NC}"
cat > server_manager.sh << 'EOL'
#!/bin/bash
...
install_script() {
    ...
    # Copy the script from the temporary directory
...
chmod +x server_manager.sh install.sh
...
echo -e "${YELLOW}You can now run the script by typing 'servermgr' in the terminal.${NC}"